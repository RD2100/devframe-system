...
| R-011 | P1 | Paper private full text leaks into evidence or reports | Paper focus status and RuntimeAuthorization contract work | Add a paper privacy gate and redacted reviewer pack before runtime use. |
