...
- Confirm SD-07 real-content/live WriteLab RuntimeAuthorization boundary is
  implemented before any real-content pilot.
...
- SD-07 is not implemented yet; `agent-acceptance` returned
  `SD07_TASKSPEC_REQUIRED` for real-content/live WriteLab authorization
  boundary work.
