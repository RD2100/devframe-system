# devframe-system Parent Pin Review A9

Date: 2026-06-15
Scope: parent-only pin review after opencode empty metadata fail-closed,
...
The A8 grouped candidate is superseded because `dev-frame-opencode` advanced
from file-type guard commit `3a72213...` to empty-metadata fail-closed commit
`58b79e2...`.
...
- `dev-frame-opencode`: empty/unrecognized metadata fail-closed accepted at
  `58b79e2...`.
...
| `dev-frame-opencode` | `0c24204fd99e6cab1d853ecadb12200244119fe1` | `58b79e292bcf3ab4dbf66cb656f9827093f48dd0` | clean at intake | empty metadata fail-closed accepted for intake | candidate |
...
- If the coordinator wants integration now, update parent gitlinks and lock
  files to the A9 candidate set, then run parent diff/submodule verification.
