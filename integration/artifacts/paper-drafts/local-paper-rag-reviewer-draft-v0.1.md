...
> Status: reviewer draft v0.1, non-final.
>
> This draft is for human review and editing. It is not paper-quality
> acceptance, not final governance acceptance, not production readiness, not
> broad/general RAG readiness, and not RuntimeAuthorization.
...
| ID | Source | Draft Use |
|---|---|---|
| S1 | `01-关于利用虚拟现实技术建立“地震救援技术虚拟训练系统”的几点思考_褚鑫杰.md` | earthquake rescue purpose and limits |
| S2 | `02-国外军用虚拟训练系统研究.md` | foreign military background |
| S3 | `03-基于虚拟现实技术的灭火救援训练系统.md` | VR fire-rescue training system |
| S4 | `04-三维建模技术在灭火救援作战训练安全中的应用初探_吴东瑾.md` | 3D modeling and fire-rescue safety training |
| S5 | `05-虚拟训练系统的虚拟场景研究.md` | virtual scene construction core |
| S6 | `06-虚拟训练系统在军事职业教育中的应用研究.md` | vocational education training support |
