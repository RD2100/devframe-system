...
$requiredPaths = @(
    ...
    "BASELINE_LOCK.json",
    "docs/status/bootstrap-report.md",
    "docs/status/completion-matrix.md",
    "docs/status/paper-feature-status.md",
    "docs/status/integration-status.md",
    "docs/status/submodules.md",
    "docs/status/risk-register.md",
    "docs/status/runbook.md",
