...
EXPECTED_HASHES = {
    "docx": "12D54BEDA62E51C75FB010EAD018B78818BC7C9059D9BE9C158B458AC3C92C51",
    "markdown": "683E654F4CB845760C2791BA4766F331C419E420A26FD36E16A3FB040EBB87E5",
    "package": "47998D1979D2A06C324932968A4D493A528A8C796B9176F50506F89C6B0C9126",
...
EXPECTED_PACKAGE_ENTRIES = [
    "ARTIFACTS-README.md",
    "CLOSEOUT-REPORT.md",
    "local-paper-rag-clean-manuscript-v0.9.docx",
    "local-paper-rag-clean-manuscript-v0.9.md",
]
...
def verify(root: Path, include_timestamp: bool = False) -> dict[str, Any]:
    ...
    paths = {
        "docx": artifacts / "local-paper-rag-clean-manuscript-v0.9.docx",
        "markdown": artifacts / "local-paper-rag-clean-manuscript-v0.9.md",
        "package": artifacts / "local-paper-rag-clean-manuscript-v0.9-package.zip",
        "readiness": reports / "parent-current-local-paper-rag-final-readiness-packet-v0-9-2026-06-16.md",
        "closeout": reports / "parent-local-paper-rag-clean-manuscript-v0-9-a1-2026-06-16.md",
    ...
    add_check(
        checks,
        "markdown_formal_short_paper_signals",
        "评价边界" in markdown and "本文的主要工作" in markdown and "过程数据" in markdown,
    )
...
def build_report(
    ...
    return {
        ...
        else "deterministic-local-paper-rag-v0.9-handoff-verification",
        "root": str(root),
        "verdict": "PASS_LOCAL_PAPER_RAG_V0_9_HANDOFF_VERIFICATION" if not failed else "FAIL",
        "non_final_boundary": {
...
def write_outputs(report: dict[str, Any], out_dir: Path) -> None:
    ...
    json_path = out_dir / "local-paper-rag-v0-9-handoff-verification.json"
    md_path = out_dir / "local-paper-rag-v0-9-handoff-verification.md"
    json_path.write_text(json.dumps(report, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    lines = [
        "# Local Paper RAG v0.9 Handoff Verification",
        "",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verify local paper RAG v0.9 handoff artifacts.")
    parser.add_argument("--root", default=".", help="Repository root. Defaults to current directory.")
    parser.add_argument(
        "--out-dir",
        default="integration/reports/local-paper-rag-v0-9-handoff-verification",
