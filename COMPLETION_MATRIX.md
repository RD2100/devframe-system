...
| 1B | `dev-frame-opencode` runtime authorization contract | Complete with boundary | Parent pins commit `72d1dbd`; RuntimeAuthorization/EvidenceManifest contracts include paper `data_policy` | Runtime enforcement and fresh authorization before live execution |
| 1B | Paper feature hardening | In progress with pinned gate and handoff fixture | Parent pins commit `72d1dbd`; paper runtime passed 80 tests; paper CLI/spec passed 23 tests; WriteLab adapter passed 63 tests; broader paper/WriteLab group passed 221 tests | Old evidence audit scan, full redacted reviewer pack, and CLI UX matrix |
