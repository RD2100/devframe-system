...
| 1B | `dev-frame-opencode` runtime authorization contract | Complete with boundary | Parent pins commit `cb34be3`; RuntimeAuthorization/EvidenceManifest contracts include paper `data_policy` | Runtime enforcement and fresh authorization before live execution |
| 1B | Paper feature hardening | In progress with pinned gate, handoff fixture, and audit scan | Parent pins commit `cb34be3`; paper runtime passed 80 tests; paper CLI/spec passed 23 tests; WriteLab adapter passed 63 tests; A25/A26/CLI privacy passed 62 tests | Full redacted reviewer pack shape, live WriteLab authorization guard coverage, and CLI UX matrix |
