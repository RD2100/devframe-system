...
Date: 2026-06-15
Status: Phase 0.5 complete; Phase 1B paper privacy gate, handoff fixture, and audit scan advanced
...
| `dev-frame-opencode` | Controlled coding runtime candidate | `cb34be3dfd72513a49996a32ecca1d2a145d64c8` | Runtime/paper privacy gate, WriteLab handoff fixture, and audit sensitive scan branch pinned |
...
| Paper feature usability and privacy boundary | P1 | Runtime/API privacy gate, WriteLab handoff fixture coverage, and audit bundle sensitive scan pinned; reviewer-pack work pending | Commit `cb34be3` includes the earlier privacy gate and fixture coverage, then fails `paper audit` closed when candidate text artifacts contain unredacted `paragraph_text`, `writelab_token`, Bearer tokens, WriteLab paragraph payloads, or matched-text payloads. Verification passed A25/A26/CLI privacy tests (62), paper runtime plus WriteLab adapter tests (143), and the earlier 221 broader paper/WriteLab group. Live WriteLab use, full reviewer-pack shape, and CLI UX matrix still need follow-up probes. |
